...
export default function Navbar() {
  ...
  const {walletFound, account, initConnection} = useContext(SmartContractContext);
  return (
    <>
      <nav className='bg-white p-4 p-5'>
        <div className='flex justify-between items-center'>
          <div className='text-grey flex items-center'>
            {/* <SiTodoist size={'2rem'} /> */}
            <div className='ml-2 text-sm md:text-lg'>To-Do Test App</div>
          </div>
